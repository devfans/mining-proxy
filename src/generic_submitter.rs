...
pub fn share_submitted(_state: &GenericSubmitterState, user_id: &Vec<u8>, user_tag_1: &Vec<u8>, value: u64, _header: &BlockHeader, _leading_zeros: u8, _required_leading_zeros: u8, _heigt: i64) {
...
pub fn event_submitted(_state: &GenericSubmitterState, event: &String) {
...
pub fn weak_block_submitted(_state: &GenericSubmitterState, user_id: &Vec<u8>, user_tag_1: &Vec<u8>, value: u64, _header: &BlockHeader, txn: &Vec<Vec<u8>>, _extra_block_data: &Vec<u8>,
	_leading_zeros: u8, _required_leading_zeros: u8, _block_hash: &Sha256dHash, _height: i64) {
